	...
	const fetchQuizzes = async () => {
		try {
			const response = await fetch(
				`${import.meta.env.VITE_BACKEND_URL}/api/quizzer/publishedquizz`,
			);
			if (!response.ok) {
...
export function useGetQuestions(quizzId) {
	...
	const fetchQuestions = async () => {
		try {
			const response = await fetch(
				`${import.meta.env.VITE_BACKEND_URL}/api/questions/${quizzId}`,
			);
			if (!response.ok) {
				throw new Error("Network response was not ok" + response.statusText);
			}
...
export function getQuizById(quizzId) {
	...
	const fetchQuiz = async () => {
		try {
			const response = await fetch(
				`${import.meta.env.VITE_BACKEND_URL}/api/quizzer/quizz/${quizzId}`,
			);
			if (!response.ok) {
				throw new Error("Network response was not ok: " + response.statusText);
			}
...
export function getQuestionByDifficulty(quizzId, difficulty) {
	...
	const fetchDifficulty = async () => {
		try {
			const response = await fetch(
				`${import.meta.env.VITE_BACKEND_URL}/api/questions/${quizzId}?difficulty=${difficulty}`,
			);
			if (!response.ok) {
				throw new Error("Network response was not ok: " + response.statusText);
			}
...
export function getQuizzByCategory(categoryId) {
	...
	const fetchCategories = async () => {
		try {
			const response = await fetch(
				`${import.meta.env.VITE_BACKEND_URL}/api/quizzer/publishedquizz?category=${categoryId}`,
			);
			if (!response.ok) {
				throw new Error("Network response was not ok: " + response.statusText);
			}
...
export function getQuizzById(quizzId) {
	...
	const fetchQuizzById = async () => {
		try {
			const response = await fetch(
				`${BACKEND_URL}/api/quizzer/quizz/${quizzId}`,
			);
			if (!response.ok) {
				throw new Error("Network response was not ok: " + response.statusText);
			}
...
export function useGetReviews(quizzId) {
	...
	const fetchReviews = async () => {
		try {
			const response = await fetch(
				`${BACKEND_URL}/api/review/allreviews/${quizzId}`,
			);
			if (!response.ok) {
				throw new Error("Network response was not ok" + response.statusText);
			}
