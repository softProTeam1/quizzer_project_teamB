					...
					if (quizzRepository.count() == 0) {
						...
						if (difficultyRepository.count() == 0) {
							...
							if (questionRepository.count() == 0) {
								...
								Question question1 = new Question("What is the staple food in most Asian countries?",
										"Rice", difficulty1,
										quizz1);
								Question question2 = new Question("Which Asian country is famous for its sushi?",
										"Japan", difficulty1,
										quizz1);
								Question question3 = new Question(
										"What is a common method of cooking in Chinese cuisine?", "Stir-frying",
										difficulty2, quizz1);
								...
								Question question6 = new Question("What is the distance of a marathon race?",
										"42 kilometers", difficulty3,
										quizz2);
								...
								Question question8 = new Question(
										"Which foreign powers colonized Vietnam in the 19th and 20th centuries?",
										"France and Japan", difficulty2, quizz3);
								Question question9 = new Question(
										"When did Vietnam gain full independence from France? ",
